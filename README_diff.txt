...
+# LearnWithNura Visual Education OS Documentation
...
+## Purpose
+This repository README is the entry point for the LearnWithNura documentation and AI onboarding infrastructure.
+It explains the documentation architecture and how future agents should use the new files.
